...
class Order:
    ...
    parent_order_id: Optional[str] = None  # For algo slices
...
class OrderManager:
    ...
    def _record_event(self, order: Order, event_type: str, details: Optional[Dict] = None):
    ...
    def cancel_all_orders(self, symbol: Optional[str] = None, strategy: Optional[str] = None):
