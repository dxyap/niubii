...
from .costs import CostModel, SimpleCostModel, TransactionCosts, OrderSide
...
class ExecutionSimulator:
    ...
    def process_bar(
        ...
        close_price = bar_data.get("close") or bar_data.get("PX_LAST")
    ...
    def get_pending_orders(self, symbol: Optional[str] = None) -> List[OrderRecord]:
