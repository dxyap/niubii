...
class AlertCondition:
    ...
    # Custom condition
    custom_function: Callable[[dict[str, Any]], bool] | None = None
...
class AlertRule:
    ...
    def evaluate(self, context: dict[str, Any]) -> AlertTrigger | None:
        """
    ...
    def _check_rate_limits(self) -> bool:
        ...
        if self._triggers_this_hour >= self.config.max_alerts_per_hour:
            return False
        return not self._triggers_today >= self.config.max_alerts_per_day
