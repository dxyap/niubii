...
from core.execution.oms import (
    ...
    TimeInForce, OrderUpdate, OrderEvent
)
from core.execution.sizing import (
    SizingConfig, SizingMethod, SizingResult,
    FixedSizer, FixedFractional, KellyCriterion,
    VolatilityTargeting, RiskParity, ATRBasedSizing, VaRBasedSizing,
    get_position_sizer, calculate_optimal_size
)
from core.execution.algorithms import (
    AlgorithmConfig, AlgorithmType, ExecutionSlice,
    TWAPAlgorithm, VWAPAlgorithm, POVAlgorithm, ImplementationShortfall,
    get_execution_algorithm
)
from core.execution.brokers import (
    Broker, BrokerConfig, BrokerStatus, ExecutionReport,
    SimulatedBroker, SimulatorConfig
)
from core.execution.paper_trading import (
    PaperTradingEngine, PaperTradingConfig, SimulatedFill
)
from core.execution.automation import (
    AutomationRule, RuleConfig, RuleCondition, RuleAction,
    RuleStatus, ConditionType, ActionType, AutomationEngine,
    create_signal_rule
)
...
class TestOrderManagementSystem:
    ...
    def test_get_active_orders(self, oms):
        ...
        order2 = oms.create_order(symbol="CO1", side=OrderSide.SELL, quantity=3)
